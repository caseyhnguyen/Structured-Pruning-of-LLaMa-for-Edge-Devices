...
def main(args):
    ...
    model = LlamaForCausalLM.from_pretrained(
        ...
        device_map={"": device}  # Force all modules to same device
    )
    ...
    if args.block_wise:
        ...
        for i in range(args.iterative_steps):
            ...
            if args.pruner_type.lower() == 'taylor':
                example_prompts = get_examples('bookcorpus', tokenizer, args.num_examples, seq_len = 64).to(device)
