...
def setup_distributed():
    """Initialize distributed training with explicit device mapping"""
...
def clear_memory():
    """Clear GPU memory and synchronize across processes"""
    gc.collect()
...
def main():
    ...
    # Set precision and optimizations
    ...
    # Synchronize before pruning with explicit device mapping
    torch.distributed.barrier(device_ids=[local_rank])
    ...
    # Final synchronization with explicit device mapping
    torch.distributed.barrier(device_ids=[local_rank])
